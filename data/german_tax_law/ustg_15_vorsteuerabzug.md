...
**Source (official, public domain / amtliches Werk):** https://www.gesetze-im-internet.de/ustg_1980/__15.html

**Retrieved:** 2026-08-15

**Topic relevance for this assistant:** Input tax deduction (Vorsteuerabzug) — contrast case for why Kleinunternehmer can't claim input tax

**Note:** This is the current consolidated version of the statute as published on gesetze-im-internet.de (Bundesministerium der Justiz). It reflects the law as currently in force, not necessarily the version applicable to a specific past tax year — cross-check effective dates for anything with a numeric threshold (e.g. Kleinunternehmer revenue limits, GWG thresholds) against the tax year being asked about.
